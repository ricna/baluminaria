...
public class MainMenuUI : MonoBehaviour
{
    ...
    [SerializeField]
    private Button _buttonBaluminaria;
    [SerializeField]
    ...
    private void Start()
    {
        ...
        _buttonBaluminaria.onClick.AddListener(OnButtonBaluminaria);
    ...
    private void OnButtonBaluminaria()
    {
        //load scene
        UnityEngine.SceneManagement.SceneManager.LoadScene("Baluminaria");
        //Application.OpenURL("https://www.unrez.com/baluminaria");
    }
